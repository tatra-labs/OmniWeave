...
`ow skills verify` (10:1368) must compute the same one. `router.py` renders the router body
(`skills/omniweave/SKILL.md`) and `tier.py` is 10:1185's one-name tier rule; the `ow skills` verbs
have no `ACTIONS` row yet (D487).
"""
